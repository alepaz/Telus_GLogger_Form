export default [
    ...
    { label: 'Employee Department', name: 'department', noValueError: 'Provide the employee\'s department' },
    { label: 'Employee Position', name: 'position', noValueError: 'Provide the employee\'s position' },
    { label: 'Employee Site', name: 'site', noValueError: 'Provide the employee\'s site' },
